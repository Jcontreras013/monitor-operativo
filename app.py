...
def main():
    ...
    if nav_menu_diamante == "📊 Centro de Reportes":
        ...
        with tab_diario:
            ...
            # --- Lógica de Avance (Mora Estricta) ---
            ...
            if not resumen_global_rep.empty:
                ...
                st.dataframe(
                    ...
                    hide_index=True,
                    column_config={
                        "TIPO": st.column_config.TextColumn("TIPO DE ORDEN"),
                        "INICIO (MORA)": st.column_config.NumberColumn("INICIO (MORA)", format="%d"),
    ...
    if nav_menu_diamante == "⚡ Monitor en Vivo":
        ...
        with st.expander("📊 CONSOLIDADO POR SEGMENTO Y AVANCE", expanded=False):
            ...
            # =====================================================================
            # --- LÓGICA: EFECTIVIDAD DE MORA (Solo órdenes de ayer o antes) ---
            # =====================================================================
            ...
            # --- DIBUJAR LAS 3 COLUMNAS DE MORA ---
        ...
        # === AQUI COMIENZA EL NUEVO EXPANDER CON LAS GRÁFICAS DE GANTT ===
        with st.expander("🎛️ PANEL DE CONTROL Y ANÁLISIS DETALLADO", expanded=True):
            ...
            with t_graphs_v:
                ...
                if not df_para_gantt_final.empty:
                    ...
                    # 1. Separar los datos por Segmento
                    ...
                    st.markdown("<h4 style='text-align: left; color: #58a6ff; border-bottom: 1px solid #58a6ff;'>🏠 Técnicos Domiciliares (Residencial)</h4>", unsafe_allow_html=True)
                    ...
                    st.markdown("<h4 style='text-align: left; color: #ff7b72; border-bottom: 1px solid #ff7b72;'>🏢 Técnicos de PLEX</h4>", unsafe_allow_html=True)
                ...
                if not df_productividad_v.empty:
                    ...
                    st.info("Sin datos de cierres para generar el gráfico horario.")
