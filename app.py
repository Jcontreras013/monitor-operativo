...
import pandas as pd
import numpy as np  # <-- AGREGADO PARA VECTORIZACIÓN DE ALTA VELOCIDAD
import os
import io
...
# ==============================================================================
# === OPTIMIZACIÓN DE RENDIMIENTO: CACHÉ + VECTORIZACIÓN CON NUMPY ===
# ==============================================================================
            ...
            if not es_movil:
                ...
                if not df_para_gantt_diario.empty:
                    ...
                    fig_gantt_d = px.timeline(
                        ...
                        text="ACTIVIDAD",  
                        hover_data={
                            # REGLA DIAMANTE: El NUM es el customdata[0], no lo muevas de arriba.
                            "NUM": True, 
                            "ACTIVIDAD": True, # <-- ESTE CAMBIO MUESTRA LA ACTIVIDAD
                            "COLONIA": True, 
                            "ESTADO": True, 
                            "Inicio": True, 
                            "Cierre": True, 
                            "Duracion": True,
                            "TECNICO": False,  # <-- ESTE CAMBIO OCULTA AL TÉCNICO DEL CUADRO
                            "GANTT_START": False, 
                            "GANTT_END": False
                        }, 
